...
function FormCadastroResponsavel({ tipo, campos, fotoSelecionada }) {
  ...
  return (
    <form className="formulario" onSubmit={handleSubmit}>
      <h2 className="titulo">Preencha os dados para se cadastrar - RESPONSÁVEL</h2>
      ...
      <div className="campos">
        ...
        <div className="linha1">
          <CampoTexto valor={nomeDependente} aoAlterar={e => setNomeDependente(e.target.value)} label="Nome do Dependente" placeholder="Digite Algo..." />
        ...
        <div className="linha2">
          ...
          <CampoTexto valor={confirmarSenha} aoAlterar={e => setConfirmarSenha(e.target.value)} label="Confirmar Senha" placeholder="Confirme Sua Senha..." />
        </div>
      </div>
